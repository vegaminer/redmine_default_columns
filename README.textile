...
* [Olivier Houdas] Made the code compatible with Redmine 3.4.x. Not backward compatible, use version 0.1.3 for previous versions of Redmine

0.1.3

* [Olivier Houdas] Fixed a crash when displaying Gantt or Agenda without any project set

0.1.2

* [Olivier Houdas] Rails 4 (Redmine 3.x) compatibility + removed compatibility with Rails version < 3
